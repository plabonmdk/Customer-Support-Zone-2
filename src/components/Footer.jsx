...
const Footer = () => {
  return (
    <footer className="bg-base-200 text-base-content border-t border-base-300">
        ...
        <div className="flex flex-col justify-between">
          <div className="flex items-center gap-4 mb-4">
            <svg
              ...
              className="text-[#422AD5]"
            >
              <path d="M12 0L15.09 7.36L23.18 8.51L17 14.14L18.18 22.24L12 18.56L5.82 22.24L7 14.14L0.82 8.51L8.91 7.36L12 0Z" />
            </svg>
            <div>
              <p className="font-bold">Plabon Chandro Modak</p>
              <p className="text-sm text-gray-500">Providing reliable tech since 2026</p>
            </div>
          </div>
      ...
      <div className="text-center border-t border-base-300 py-4 text-gray-500 text-sm">
